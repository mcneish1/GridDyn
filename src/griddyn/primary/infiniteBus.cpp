...
void infiniteBus::setState (coreTime time, const double state[], const double dstate_dt[], const solverMode &sMode)
{
    updateVoltageAngle (time);
...
double infiniteBus::getVoltage (const double /*state*/[], const solverMode & /*sMode*/) const { return voltage; }

double infiniteBus::getAngle (const double /*state*/[], const solverMode & /*sMode*/) const { return angle; }
...
bool infiniteBus::checkCapable () { return true; }
