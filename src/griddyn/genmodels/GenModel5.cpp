...
#include "griddyn/genmodels/GenModel5.h"
...
// initial conditions
void GenModel5::dynObjectInitializeB (const IOdata &inputs, const IOdata &desiredOutput, IOdata &fieldSet)
{
                                  ...
                                  const solverMode &sMode)
{
    ...
    if (hasDifferential (sMode))
    {
        ...
        md.assignCheckCol (refDiff + 3, inputLocs[genModelEftInLocation], 1 / Tdop);  // exciter: Ef
