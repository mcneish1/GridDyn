...
// initial conditions
void GenModel6::dynObjectInitializeB (const IOdata &inputs, const IOdata &desiredOutput, IOdata &fieldSet)
{
    if (Tqop == 0)
    {
        Tqop = 0.01;
...
void GenModel6::derivative (const IOdata &inputs, const stateData &sD, double deriv[], const solverMode &sMode)
{
...
static const stringVec genModel6Names{"id", "iq", "delta", "freq", "edp", "eqp", "edpp", "eqpp"};
