...
void GenModel6type2::residual (const IOdata &inputs, const stateData &sD, double resid[], const solverMode &sMode)
{
...
static const stringVec genModel6type2Names{"id", "iq", "delta", "freq", "edp", "eqp", "edpp", "eqpp"};
