...
#include "griddyn/loads/aggregateLoad.h"
...
void aggregateLoad::residual (const IOdata &inputs, const stateData &sD, double resid[], const solverMode &sMode)
{
    for (auto &ld : subLoads)
    {
...
void aggregateLoad::derivative (const IOdata &inputs, const stateData &sD, double deriv[], const solverMode &sMode)
{
    for (auto &ld : subLoads)
    {
...
double aggregateLoad::getRealPower (const IOdata &inputs, const stateData &sD, const solverMode &sMode) const
{
    double rp = 0;
    for (auto &ld : subLoads)
    {
...
double aggregateLoad::getReactivePower (const IOdata &inputs, const stateData &sD, const solverMode &sMode) const
{
    double rp = 0;
    for (auto &ld : subLoads)
    {
