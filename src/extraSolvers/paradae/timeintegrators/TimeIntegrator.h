...
public:
    TimeIntegrator() { do_braid = false; do_varstep = false; do_falsevarstep = false; dense_mat = true; nb_steps_done = 0; };
    ...
    void SetNewtonSolverOpt(int max_iter, Real tol_, bool update) { newton = Newton(max_iter, tol_, update); };
