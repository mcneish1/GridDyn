...
public:
  ...
  virtual void EvaluateFunAndJac(const Vector& allK, Vector& gx, bool require_jac, bool factorize){abort();};
};
...
public:
  ...
  bool EstimateNextStepSize(const Vector& x0, const Vector& x1, const SMultiVector& allK, const Real& used_dt, Real& refinement);
