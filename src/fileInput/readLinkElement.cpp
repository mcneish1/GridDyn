...
Link *
readLinkElement (std::shared_ptr<readerElement> &element, readerInfo &ri, coreObject *searchObject, bool warnlink)
{
    auto riScope = ri.newScope ();

    // run the boilerplate code to setup the object
    Link *lnk = ElementReaderSetup (element, static_cast<Link *>(nullptr), linkComponentName, ri, searchObject);
