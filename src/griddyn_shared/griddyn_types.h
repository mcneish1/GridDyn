...
typedef struct { char unused; } griddyn_object;
typedef struct { char unused; } griddyn_sim;
typedef struct { char unused; } griddyn_query;
typedef struct { char unused; } griddyn_query_vector;
typedef struct { char unused; } griddyn_event;
typedef struct { char unused; } griddyn_solver;
