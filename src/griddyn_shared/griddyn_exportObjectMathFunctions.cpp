...
griddyn_status gridDynObject_residual (griddyn_object *obj,
                                       const double *inputs,
                                       int inputSize,
                                       double *resid,
                                       griddyn_solver *key)
{
    ...
    comp->residual (IOdata (inputs, inputs + inputSize), emptyStateData, keyInfo->stateBuffer.data (),
                    keyInfo->sMode_);
    TranslateToLocal (keyInfo->stateBuffer, resid, comp, keyInfo->sMode_);
    return griddyn_ok;
}

griddyn_status gridDynObject_derivative (griddyn_object *obj,
                                         const double *inputs,
                                         int inputSize,
                                         double *deriv,
                                         griddyn_solver *key)
{
    ...
    comp->derivative (IOdata (inputs, inputs + inputSize), emptyStateData, keyInfo->stateBuffer.data (),
                      keyInfo->sMode_);
                                              ...
                                              griddyn_solver *key)
{
    ...
    comp->algebraicUpdate (IOdata (inputs, inputs + inputSize), emptyStateData, keyInfo->stateBuffer.data (),
                           keyInfo->sMode_, alpha);
                                                   ...
                                                   const griddyn_solver *key)
{
    ...
    comp->ioPartialDerivatives (IOdata (inputs, inputs + inputSize), emptyStateData, md, defInputlocs,
                                keyInfo->sMode_);
    return griddyn_ok;
}
