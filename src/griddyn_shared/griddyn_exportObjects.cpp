...
gridComponent *getComponentPointer (griddyn_object *obj) { return static_cast<gridComponent *> (obj); }
...
griddyn_status griddyn_object_get_value_units (const griddyn_object *obj,
