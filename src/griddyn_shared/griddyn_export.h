...
extern "C"
{
     ...
     * @return a griddyn_object that represents the newly created object
     */
    GRIDDYN_EXPORT griddyn_object *griddyn_object_copy (const griddyn_object *obj);
     ...
     */
    GRIDDYN_EXPORT griddyn_status griddyn_object_remove (const griddyn_object *parentObject,
                                                         const griddyn_object *objectToRemove);
     ...
     */
    GRIDDYN_EXPORT griddyn_status griddyn_object_set_string (griddyn_object *obj,
     ...
     * @return 0 on success, negative otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_object_set_value (griddyn_object *obj,
                                                            const char *parameter,
                                                            double value);
     ...
     * @return 0 on success, negative otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_object_set_value_units (const griddyn_object *obj,
                                                                  const char *parameter,
                                                                  double value,
                                                                  const char *units);
     ...
     * @return 0 on success, negative otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_object_set_flag (const griddyn_object *obj, const char *flag, int val);
     ...
     */
    GRIDDYN_EXPORT int
    griddyn_object_get_string (const griddyn_object *obj, const char *parameter, char *value, int N);
     ...
     */
    GRIDDYN_EXPORT griddyn_status griddyn_object_get_value (const griddyn_object *obj,
                                                            const char *parameter,
                                                            double *result);
     ...
     * @return 0 if the value is valid or griddyn_unknown_parameter Otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_object_get_value_units (const griddyn_object *obj,
                                                                  const char *parameter,
                                                                  const char *units,
                                                                  double *result);
     ...
     */
    GRIDDYN_EXPORT griddyn_status griddyn_object_get_flag (const griddyn_object *obj,
                                                           const char *flag,
                                                           int *result);
     ...
     */
    GRIDDYN_EXPORT griddyn_object *griddyn_object_find (const griddyn_object *obj, const char *objectToFind);
     ...
     */
    GRIDDYN_EXPORT griddyn_object *
    griddyn_object_get_sub_object (const griddyn_object *obj, const char *componentType, int N);
     ...
     */
    GRIDDYN_EXPORT griddyn_object *
    griddyn_object_find_by_user_id (const griddyn_object *obj, const char *componentType, int ID);
     ...
     */
    GRIDDYN_EXPORT griddyn_object *griddyn_object_get_parent (const griddyn_object *obj);
     ...
     */
    GRIDDYN_EXPORT const char *griddyn_object_get_type (const griddyn_object *obj);
     ...
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_initialize_from_string (const griddyn_sim *sim,
     ...
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_initialize_from_args (const griddyn_sim *sim,
                                                                           int argc,
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_load_file (griddyn_sim *sim,
                                                                const char *fileName,
                                                                const char *fileType);
     ...
     * it this includes scripting and execution order once a command queue is set up the run command will execute
     * the command queue
     * @param[in] sim the simulation runner reference object
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_add_command (const griddyn_sim *sim, const char *command);

    /** initialize the simulation so it is ready to execute a power flow
     * @param[in] sim the simulation runner reference object
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_powerflow_initialize (const griddyn_sim *sim);
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_dynamic_initialize (const griddyn_sim *sim);

    /** reset the simulation to time 0
     * @param[in] sim the simulation runner reference object
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_reset (const griddyn_sim *sim);

    /** get the current simulation time
     * @param sim the simulation runner reference object
     * @return the simulation time in seconds
     */
    GRIDDYN_EXPORT double griddyn_simulation_get_current_time (const griddyn_sim *sim);
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_run_to (const griddyn_sim *sim, double runToTime);

    /** step the simulator one event step
     * @param[in] sim the simulation runner reference object
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_step (const griddyn_sim *sim);
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_run_async (const griddyn_sim *sim);
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_run_to_async (const griddyn_sim *sim, double runToTime);

    /** step the simulator one event step
     * @param[in] sim the simulation runner reference object
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_step_async (const griddyn_sim *sim);
     ...
     * state
     */
    GRIDDYN_EXPORT int griddyn_simulation_get_status (const griddyn_sim *sim);
     ...
     */
    GRIDDYN_EXPORT griddyn_solver griddyn_simulation_get_solver_handle (const griddyn_sim *sim,
     ...
     */
    GRIDDYN_EXPORT int griddyn_simulation_get_state_size (const griddyn_sim *sim, griddyn_solver key);

    /** get the number of buses in the simulation
     * @param[in] sim the simulation runner reference object
     * @return  the number of buses in the simulation
     */
    GRIDDYN_EXPORT int griddyn_simulation_get_bus_count (const griddyn_sim *sim);

    /** get the number of lines in the simulation
     * @param[in] sim the simulation runner reference object
     * @return  the number of lines in the simulation
     */
    GRIDDYN_EXPORT int griddyn_simulation_get_line_count (const griddyn_sim *sim);
     ...
     */
    GRIDDYN_EXPORT int
    griddyn_simulation_get_results (griddyn_sim *sim, const char *dataType, double *data, int maxSize);
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_guess_state (const griddyn_sim *sim,
                                                                  double time,
                                                                  double *states,
                                                                  double *dstate_dt,
                                                                  griddyn_solver key);
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_set_state (const griddyn_sim *sim,
                                                                double time,
                                                                const double *states,
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_get_state_variable_types (const griddyn_sim *sim,
                                                                               double *types,
                                                                               griddyn_solver key);
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_residual (const griddyn_sim *sim,
                                                               double time,
                                                               double *resid,
                                                               const double *states,
                                                               const double *dstate_dt,
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_derivative (const griddyn_sim *sim,
                                                                 double time,
                                                                 double *deriv,
                                                                 const double *states,
                                                                 griddyn_solver key);
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_algebraic_update (const griddyn_sim *sim,
                                                                       double time,
                                                                       double *update,
                                                                       const double *states,
                                                                       double alpha,
     ...
     * @return 0 if successful an error code otherwise
     */
    GRIDDYN_EXPORT griddyn_status griddyn_simulation_jacobian (const griddyn_sim *sim,
                                                               double time,
                                                               const double *states,
                                                               const double *dstate_dt,
                                                               double cj,
     ...
     */
    GRIDDYN_EXPORT griddyn_status griddyn_query_vector_append (griddyn_query_vector query,
                                                               griddyn_object obj,
     ...
     * @param[in] queryString a string describing the new queries to add
     */
    GRIDDYN_EXPORT griddyn_status griddyn_query_update (griddyn_query query,
                                                        griddyn_object obj,
                                                        const char *queryString);
     ...
     */
    GRIDDYN_EXPORT griddyn_status griddyn_query_vector_update (griddyn_query_vector query,
                                                               griddyn_object obj,
                                                               const char *queryString);
     ...
     * @return 0 for success or an error code representing an issue
     */
    GRIDDYN_EXPORT griddyn_status griddyn_event_schedule (griddyn_event evnt, const griddyn_sim *sim);
     ...
     * @return 0 for success or an error code representing an issue
     */
    GRIDDYN_EXPORT griddyn_status griddyn_event_set_value (griddyn_event evnt,
                                                           const char *parameter,
                                                           double value);
     ...
     * @return 0 for success or an error code representing an issue
     */
    GRIDDYN_EXPORT griddyn_status griddyn_event_set_string (griddyn_event evnt,
                                                            const char *parameter,
                                                            const char *value);
