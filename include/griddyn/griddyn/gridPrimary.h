...
class gridPrimary : public gridComponent
{
  ...
  public:
    ...
    */
    virtual void
    delayedResidual (const IOdata &inputs, const stateData &sD, double resid[], const solverMode &sMode);
    ...
    */
    virtual void
    delayedDerivative (const IOdata &inputs, const stateData &sD, double deriv[], const solverMode &sMode);
