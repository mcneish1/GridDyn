...
class gridSimulation : public Area
{
  public:
    ...
    enum class gridState_t : int
    {
        ...
        INITIALIZED = 1,  //!< the system has completed a power flow initialization step and is ready to proceed to
        ...
        DYNAMIC_COMPLETE = 4,  //!< the system has completed a dynamic system calculation and advanced to the
