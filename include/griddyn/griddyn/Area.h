...
class Area : public gridPrimary
{
  ...
  public:
    ...
    enum area_flags
    {
        ...
        direction_oscillate = object_flag2,  //!< flag indicating that the direction of iteration for convergence
  ...
  public:
    ...
    */
    ...
    virtual void
    delayedResidual (const IOdata &inputs, const stateData &sD, double resid[], const solverMode &sMode) override;
    ...
    */
    count_t
    getAngle (std::vector<double> &angles, const double state[], const solverMode &sMode, index_t start = 0) const;
    ...
    @return an index where the last value was placed
    */
    count_t getLinkRealPower (std::vector<double> &powers, index_t start = 0, int busNumber = 1) const;
    ...
    @return an index where the last value was placed
    */
    count_t getLinkReactivePower (std::vector<double> &powers, index_t start = 0, int busNumber = 1) const;
