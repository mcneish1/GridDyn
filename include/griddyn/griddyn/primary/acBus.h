...
class acBus : public gridBus
{
  ...
  public:
    ...
    virtual void
    voltageUpdate (const stateData &sD, double update[], const solverMode &sMode, double alpha) override;
  ...
  public:
    ...
    */
    ...
    virtual void getVariableType (double sdata[], const solverMode &sMode) override;  // only applicable in DAE
                                                                                      // mode
