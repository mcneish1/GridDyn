...
public:
  ...
  std::vector<Link *> proxyVControlObject;        //!< object which act as an interface for remote objects acting on a bus
  std::vector<Link *> vControlLinks;          //!< set of Link which themselves act as controllable objects;
  ...
  std::vector<Link *> proxyPControlObject;       //!< object which act as an interface for remote objects acting on a bus
  std::vector<Link *> pControlLinks;          //!< set of Link which themselves act as controllable power objects;
