...
class coreObjectFactory
{
  public:
    ...
    */
    ...
    @return the created coreObject */
    coreObject *
    createObject (const std::string &component, const std::string &typeName, const std::string &objName);
    ...
    */
    void
    prepObjects (const std::string &component, const std::string &typeName, count_t numObjects, coreObject *obj);
