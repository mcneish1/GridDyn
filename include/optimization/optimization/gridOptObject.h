...
class gridOptObject : public coreObject
{
  ...
  public:
    ...
    */
    ...
    @param oMode the optimization mode to use.
    */
    virtual void valueBounds (double time, double upLimit[], double lowerLimit[], const optimMode &oMode);

    /** load the linear objective parameters
    @param oD  the current objective variable values
    ...
    */
    ...
    @param oMode the optimization mode to use.
    */
    virtual void jacobianElements (const optimData &oD, matrixData<double> &md, const optimMode &oMode);
    ...
    */
    ...
    @param oMode the optimization mode to use.
    */
    virtual void constraintJacobianElements (const optimData &oD, matrixData<double> &md, const optimMode &oMode);
    ...
    @param oMode the optimization mode to use.
    */
    virtual void hessianElements (const optimData &oD, matrixData<double> &md, const optimMode &oMode);
