...
{
    auto reader =
      std::make_shared<tinyxmlReaderElement> (elementReaderTestDirectory + "xmlElementReader_test3.xml");
...
{
    auto reader =
      std::make_shared<tinyxml2ReaderElement> (elementReaderTestDirectory + "xmlElementReader_test3.xml");
    BOOST_CHECK (reader->getName () == "main_element");
