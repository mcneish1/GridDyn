...
BOOST_AUTO_TEST_CASE (trimString_tests)
{
    ...
    std::string_view test2 = "  \t1234:AbC\n\t RTrt\n ";
    test2 = trim (test2);
    ...
    std::string_view test4 = "%%**Bill45 *%*%";
    test4 = trim (test4, "*%");
    BOOST_CHECK (test4 == "Bill45 ");

    std::string_view test5 = "AbCd: *Ty; ";
    trimString (test5);
    BOOST_CHECK (test5 == "AbCd: *Ty;");
    std::string_view test6 = "  \t1234:AbC\n\t RTrt\n ";
    trimString (test6);
...
BOOST_AUTO_TEST_CASE (splitLineQuotes_tests)
{
    ...
    std::string_view test3 = " \"test1\",\'test2\' ; \"charlie\",";
